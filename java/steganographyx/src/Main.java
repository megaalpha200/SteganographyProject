...
public class Main {
    ...
    private static void encode() throws IOException, NoSuchFileException {
        ...
        final String msgInput = bufferedReader.readLine();
        System.out.println();
        ...
        final String encodedImgSaveLoc = Steganography.generateEncodedImage(Steganography.embedMessage(ImageIO.read(new File(originalPath)), msgInput), newPath);
        System.out.println();
